      ...
      <section className="pt-36 pb-20 px-8">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div>
              <span className="inline-block text-xs font-semibold tracking-widest uppercase bg-emerald-50 text-emerald-600 px-3 py-1.5 rounded-full mb-6">Scheduling</span>
              <h1 className="text-5xl md:text-6xl font-bold tracking-tight mb-4">Schedule AI</h1>
              <p className="text-xl font-semibold text-[#0E0E2C]/70 mb-5 leading-snug">Every deadline tracked. Every calendar managed.</p>
